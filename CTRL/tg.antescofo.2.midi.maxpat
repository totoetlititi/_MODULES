...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 267.5, 168.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					"allowdrag" : 0,
					"id" : "obj-166",
					"items" : [ "Gestionnaire IAC Bus 1", ",", "Gestionnaire IAC IAC Bus 2", ",", "Network Session 1", ",", "Fireface 800 (10D) Port 1", ",", "to Max 1", ",", "to Max 2", ",", "from Max 1", ",", "from Max 2" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
