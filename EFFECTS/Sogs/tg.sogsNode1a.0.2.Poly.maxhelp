...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 16.0, 34.5, 100.0, 40.0 ],
					"text" : "poly~ tg.sogsNode1a.0.2.Poly 1 args 1sogn",
					"varname" : "poly~[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.0, 248.5, 133.0, 27.0 ],
					"text" : ";\r1sogn Outgain 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.0, 187.5, 109.0, 27.0 ],
					"text" : ";\r1sogn.INIT bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.0, 132.5, 109.0, 27.0 ],
					"text" : ";\r1sogn.interface open"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "tg.sogsNode1a.0.2.Poly.maxpat",
