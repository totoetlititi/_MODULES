...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "", "" ],
					"patching_rect" : [ 27.0, 80.0, 157.0, 18.0 ],
					"text" : "tg.SpectralDelay.1.1 #1",
					"varname" : "tg.SpectralDelay"
				}
...
,
					"patching_rect" : [ 27.0, 175.0, 111.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial Bold",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 139.0, 247.0, 42.0, 18.0 ],
					"text" : "On/Off"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 119.0, 247.0, 20.0, 20.0 ]
				}
...
,
					"patching_rect" : [ 27.0, 135.0, 65.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial Bold",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 33.0, 96.0, 18.0 ],
					"text" : "r #1"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "tg.SpectralDelay.1.1.maxpat",
