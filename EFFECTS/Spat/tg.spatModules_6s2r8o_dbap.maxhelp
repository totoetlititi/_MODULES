...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 368.5, 426.5, 19.0, 18.0 ],
					"text" : "8"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 368.5, 464.5, 19.0, 18.0 ],
					"text" : "6"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 387.5, 445.5, 19.0, 18.0 ],
					"text" : "O"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 407.0, 464.5, 19.0, 18.0 ],
					"text" : "4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 415.5, 445.5, 19.0, 18.0 ],
					"text" : "3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 387.5, 469.5, 19.0, 18.0 ],
					"text" : "5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 361.0, 445.5, 19.0, 18.0 ],
					"text" : "7"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 407.0, 426.5, 19.0, 18.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 387.5, 421.5, 19.0, 18.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 221.0, 390.5, 194.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 221.0, 408.5, 130.0, 105.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 17.0, 208.0, 193.0, 29.0 ],
					"text" : "tg.spatModules_6s2r8o_dbap 1spat 1rev 2rev",
					"varname" : "poly~"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "tg.spatModules_6s2r8o_dbap.maxpat",
