...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 387.5, 448.5, 19.0, 18.0 ],
					"text" : "O"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 403.5, 472.5, 19.0, 18.0 ],
					"text" : "6"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 415.5, 448.5, 19.0, 18.0 ],
					"text" : "4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 372.5, 472.5, 19.0, 18.0 ],
					"text" : "5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 359.0, 448.5, 19.0, 18.0 ],
					"text" : "3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 403.5, 424.5, 19.0, 18.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 372.5, 424.5, 19.0, 18.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 221.0, 417.5, 129.0, 83.0 ],
					"text" : ";\r1spat speaker 1 ad -45 1, speaker 2 ad 45 1, speaker 3 ad -90 1, speaker 4 ad 90 1, speaker 5 ad -135 1, speaker 6 ad 135 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 221.0, 525.5, 149.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 221.0, 541.5, 419.0, 72.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "tg.spatModules_6s2r6o_dbap 1spat 1rev 2rev",
					"varname" : "poly~"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "tg.spatModules_6s2r6o_dbap.maxpat",
