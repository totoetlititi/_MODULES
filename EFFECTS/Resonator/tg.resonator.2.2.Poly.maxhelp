...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 667.0, 520.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 667.0, 544.0, 85.0, 18.0 ],
					"text" : "metro 5100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 667.0, 569.5, 85.0, 18.0 ],
					"text" : "random 25"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 528.5, 21.0, 194.0, 18.0 ],
					"text" : "recall a preset from default reson bank"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 507.0, 49.0, 100.0, 18.0 ],
					"text" : "delay 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 507.0, 21.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 507.0, 203.0, 109.0, 27.0 ],
					"text" : ";\r1res clear 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 507.0, 290.0, 377.0, 72.0 ],
					"text" : ";\r1res Dry/wet 100., FilterFreq 1000., FilterGain 0., FilterMode 5., FilterQ 0.3, Ingain 0., Outgain 0., ampscale -58.984253, corner 20., formant 0., inharm 0., interp 100., interp-rate 100., interpauto 1., interpsteps 1., model 21., modelCollName collVowels, pitch 100., pitchbase 100., rescale 0.064012, slope 0., transp 1., vibdepth 0., vibfreq 100., vibsize 1., vibsmooth 0.,"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 507.0, 72.5, 377.0, 72.0 ],
					"text" : ";\r1res Dry/wet 100., FilterFreq 1000., FilterGain 0., FilterMode 5., FilterQ 0.3, Ingain 0., Outgain -0.391956, ampscale -10., corner 20., formant 0., inharm 0., interp 100., interp-rate 100., interpauto 1., interpsteps 1., model 172., modelCollName <default>, pitch 100., pitchbase 100., rescale 1., slope 0., transp 1., vibdepth 0., vibfreq 100., vibsize 1., vibsmooth 0.,"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 415.0, 146.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 393.0, 176.0, 41.0, 18.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 393.0, 121.0, 37.0, 18.0 ],
					"text" : "*~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 393.0, 90.0, 61.0, 18.0 ],
					"text" : "noise~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 95.0, 390.5, 69.0, 16.0 ],
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 326.0, 146.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 304.0, 176.0, 41.0, 18.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 304.0, 121.0, 37.0, 18.0 ],
					"text" : "*~ 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 304.0, 90.0, 61.0, 18.0 ],
					"text" : "cycle~ 440"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 95.0, 327.0, 25.0, 18.0 ],
					"text" : "Init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 95.0, 344.5, 109.0, 27.0 ],
					"text" : ";\r1res.INIT bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 95.0, 290.0, 109.0, 27.0 ],
					"text" : ";\r1res.interface open"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "tg.resonator.2.2.Poly.maxpat",
