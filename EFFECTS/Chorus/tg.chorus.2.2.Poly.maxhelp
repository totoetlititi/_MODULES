...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation_rect" : [ 100.5, 296.0, 0.0, 0.0 ],
					"text" : "Open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 99.5, 423.0, 133.0, 27.0 ],
					"text" : ";\r1cho.storage recall Test1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 99.5, 405.0, 41.0, 18.0 ],
					"text" : "Preset"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "poly~ tg.chorus.2.2.Poly 1 args 1cho",
					"varname" : "poly~"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-1.1::obj-1::obj-84" : [ "Smooth", "Smooth", 0 ],
			"obj-1.1::obj-1::obj-70" : [ "FilterFreq", "FilterFreq", 0 ],
			"obj-1.1::obj-1::obj-82" : [ "Depth", "Depth", 0 ],
...
,
		"dependency_cache" : [ 			{
				"name" : "tg.chorus.2.2.Poly.maxpat",
				"bootpath" : "/Users/goepfer/Documents/MAX-LIBRARY/TG.tools/_MODULES/EFFECTS/Chorus",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
