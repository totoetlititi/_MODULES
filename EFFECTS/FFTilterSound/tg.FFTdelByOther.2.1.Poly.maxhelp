...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "poly~ tg.FFTdelByOther.2.1.Poly 1 args 1fftd",
					"varname" : "poly~"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "tg.FFTdelByOther.2.1.Poly.maxpat",
