...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 574.0, 319.0, 100.0, 18.0 ],
					"text" : "delay 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 535.0, 261.0, 83.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.0, 75.0, 315.0, 94.0 ],
					"text" : ";\r1mng BufferSize 200., Clear 0., Direction 1., Dry/wet 100., Fade 5., FilterFreq 1000., FilterGain 0., FilterMode 5., FilterQ 0.3, Gain 0., GainVar 99.212601, Ingain 0., MaxVoices 20., MinSize 0., Outgain 0., Position 0.007519, RampTime 50., RandPosition 1., Record 1., Separ 10., SeparVar 10., Size 4.143385, SizeVar 10., StereoSpread 100., Transp 0., TranspMode 0., TranspScale -24 -12 0 12 24, TranspVar 0.208251, Voices 10.,"
				}
...
, 			{
				"box" : 				{
					"addpoints_with_curve" : [ 10.638297, -24.242399, 0, 0.0, 2925.531982, 2400.0, 0, 0.395, 3776.595703, 1087.999878, 0, 0.0, 5904.255371, 2112.0, 0, 0.0, 7180.851074, 512.0, 0, -0.345, 10000.0, 0.0, 0, -0.7 ],
					"domain" : 10000.0,
					"id" : "obj-19",
...
, 			{
				"box" : 				{
					...
					"text" : "poly~ tg.Munger.2.2.Poly 1 args 1mng",
					"varname" : "poly~"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "tg.Munger.2.2.Poly.maxpat",
				"bootpath" : "/Users/goepfer/Documents/MAX-LIBRARY/TG.tools/_MODULES/EFFECTS/Munger",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
