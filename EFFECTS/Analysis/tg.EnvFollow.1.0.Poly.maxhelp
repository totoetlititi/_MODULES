...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 364.0, 591.0, 133.0, 27.0 ],
					"presentation_rect" : [ 275.0, 504.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 364.0, 553.0, 100.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 364.0, 522.0, 50.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 364.0, 491.0, 100.0, 18.0 ],
					"text" : "r to1biq"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 364.0, 458.0, 133.0, 27.0 ],
					"presentation_rect" : [ 274.0, 345.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 275.0, 281.0, 133.0, 27.0 ],
					"presentation_rect" : [ 275.0, 281.0, 0.0, 0.0 ],
					"text" : ";\r1env Ingain 0"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 275.0, 263.0, 0.0, 0.0 ],
					"text" : "Preset"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 275.0, 159.0, 0.0, 0.0 ],
					"text" : "Open"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 275.0, 214.0, 0.0, 0.0 ],
					"text" : "Init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 275.0, 232.0, 109.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 275.0, 177.0, 109.0, 27.0 ],
					"presentation_rect" : [ 275.0, 177.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 144.5, 177.0, 106.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 364.0, 393.0, 158.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 18.0, 289.0, 105.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 18.0, 14.0, 272.0, 136.0 ],
...
, 			{
				...
				"bootpath" : "/Users/goepfer/Documents/MAX-LIBRARY/TG.tools/_MODULES/EFFECTS/Analysis",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
