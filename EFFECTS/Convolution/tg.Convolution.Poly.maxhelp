...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 317.0, 22.0, 272.0, 136.0 ],
					"presentation_rect" : [ 314.0, 18.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 305.333344, 487.0, 309.0, 49.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "poly~ tg.Convolution.Poly 1 args 1conv",
					"varname" : "poly~"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "tg.Convolution.Poly.maxpat",
