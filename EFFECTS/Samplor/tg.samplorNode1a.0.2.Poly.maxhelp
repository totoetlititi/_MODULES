...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 346.0, 292.5, 132.0, 27.0 ],
					"text" : ";\r1samn Coll DRUM1.COLL"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 346.0, 254.0, 153.0, 27.0 ],
					"text" : ";\r1samn Coll DRUM1light.COLL"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.0, 344.5, 155.0, 27.0 ],
					"text" : ";\r1samn.STORAGE preset Test1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.0, 310.5, 135.0, 27.0 ],
					"text" : ";\r1samn.STORAGE preset 2"
				}
...
, 			{
				"box" : 				{
					"embed_buffers" : 					{
						"DRUM1.1" : "BellPlate.aiff",
						"DRUM1.2" : "Bongo1.aiff",
						"DRUM1.3" : "Bongo2.aiff",
						"DRUM1.4" : "ChineseCymbal.aiff",
						"DRUM1.5" : "CoreanGong.aiff",
						"DRUM1.6" : "Glockenspiel.aiff",
						"DRUM1.7" : "LogDrum.aiff",
						"DRUM1.8" : "LowCowbell.aiff",
						"DRUM1.9" : "SnareDrum.aiff",
						"DRUM1.10" : "Stone.aiff",
						"DRUM1.11" : "TempleBlock1.aiff",
						"DRUM1.12" : "TempleBlock2.aiff",
						"DRUM1.13" : "TempleBlock3.aiff",
						"DRUM1.14" : "TempleBlock4.aiff",
						"DRUM1.15" : "Timpani.aiff",
						"DRUM1.16" : "Triangle.aiff"
					}
,
					"fontname" : "Arial Bold",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 16.0, 34.5, 100.0, 51.0 ],
					"text" : "poly~ tg.samplorNode1a.0.2.Poly 1 args 1samn",
					"varname" : "poly~[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 125.0, 114.5, 36.0, 18.0 ],
					"text" : "Open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.0, 248.5, 91.0, 27.0 ],
					"text" : ";\r1samn Outgain 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 125.0, 230.5, 47.0, 18.0 ],
					"text" : "Outgain"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 125.0, 169.5, 25.0, 18.0 ],
					"text" : "Init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.0, 187.5, 91.0, 27.0 ],
					"text" : ";\r1samn.INIT bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 125.0, 132.5, 113.0, 27.0 ],
					"text" : ";\r1samn.interface open"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 254.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 16.0, 89.0, 48.0, 136.0 ],
...
, 			{
		...
		"parameters" : 		{
			"obj-11.1::obj-4::obj-318" : [ "ShakePos", "ShakePos", 0 ],
			"obj-11.1::obj-4::obj-305" : [ "Spread", "Spread", 0 ],
			"obj-11.1::obj-4::obj-214" : [ "Coll", "Coll", 0 ],
			"obj-11.1::obj-4::obj-70" : [ "FilterFreq", "FilterFreq", 0 ],
			"obj-11.1::obj-4::obj-300" : [ "Expand", "Expand", 0 ],
			"obj-11.1::obj-4::obj-81" : [ "Edit", "Edit", 0 ],
			"obj-11.1::obj-4::obj-322" : [ "ShakeSize", "ShakeSize", 0 ],
			"obj-11.1::obj-4::obj-162" : [ "Vel[1]", "Vel", 1 ],
			"obj-11.1::obj-4::obj-67" : [ "FilterGain", "FilterGain", 0 ],
			"obj-11.1::obj-4::obj-76" : [ "ShiftX", "ShiftX", 0 ],
			"obj-11.1::obj-4::obj-161" : [ "Vel", "Vel", 1 ],
			"obj-11.1::obj-4::obj-42" : [ "FilterMode", "FilterMode", 0 ],
			"obj-11.1::obj-4::obj-215" : [ "live.text", "live.text", 0 ],
			"obj-11.1::obj-4::obj-89" : [ "Nodes", "Nodes", 0 ],
			"obj-11.1::obj-4::obj-303" : [ "Rotate", "Rotate", 0 ],
			"obj-11.1::obj-4::obj-298" : [ "ShiftY", "ShiftY", 0 ],
			"obj-11.1::obj-4::obj-72" : [ "FilterQ", "FilterQ", 0 ],
			"obj-11.1::obj-4::obj-169" : [ "Vel[3]", "Vel", 1 ],
			"obj-11.1::obj-4::obj-48" : [ "Azimuth", "Azimuth", 1 ],
			"obj-11.1::obj-4::obj-309" : [ "Shake", "Shake", 0 ],
			"obj-3" : [ "live.gain~", "live.gain~", 0 ],
			"obj-11.1::obj-4::obj-80" : [ "PRESET", "PRESET", 0 ],
			"obj-11.1::obj-4::obj-14" : [ "Outgain", "Outgain", 0 ],
			"obj-11.1::obj-4::obj-168" : [ "Vel[2]", "Vel", 1 ],
			"obj-11.1::obj-4::obj-47" : [ "Distance", "Distance", 1 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "tg.samplorNode1a.0.2.Poly.maxpat",
...
, 			{
				"name" : "tg.samplorNode1a.0.2.maxpat",
				"bootpath" : "/Users/goepfer/Documents/MAX-LIBRARY/TG.tools/_MODULES/EFFECTS/Samplor",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
